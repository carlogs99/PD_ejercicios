...
moverDisco torre@(Torre [] _ _) "I" _ = torre
moverDisco torre@(Torre _ [] _) "C" _ = torre
moverDisco torre@(Torre _ _ []) "D" _ = torre
moverDisco (Torre is cs (d:ds)) "D" "C" = Torre is (d:cs) ds
moverDisco (Torre is (c:cs) ds) "C" "D" = Torre is cs (c:ds)
moverDisco (Torre is cs (d:ds)) "D" "I" = Torre (d:is) cs ds
moverDisco (Torre (i:is) cs ds) "I" "D" = Torre is cs (i:ds)
moverDisco (Torre is (c:cs) ds) "C" "I" = Torre (c:is) cs ds
moverDisco (Torre (i:is) cs ds) "I" "C" = Torre is (i:cs) ds
...
grado :: (Ord a, Num a) => Polinomio a -> a 
grado PolCero = 0
grado (Pol (b,e) pol) = max e (grado pol)
